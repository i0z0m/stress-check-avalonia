...
public static class LoadSections
{
    public static List<Section> sections = new List<Section>
    {
        ...
        new Section
        {
            ...
            Questions = new List<Question>
            {
                new Question { Id = 1, Text = "次の人たちとはどのくらい気軽に話ができますか？\n上司", Score = 0, Reverse = false },
                new Question { Id = 2, Text = "次の人たちとはどのくらい気軽に話ができますか？\n職場の同僚", Score = 0, Reverse = false },
                new Question { Id = 3, Text = "次の人たちとはどのくらい気軽に話ができますか？\n配偶者、家族、友人等", Score = 0, Reverse = false },
                new Question { Id = 4, Text = "あなたが困った時、次の人たちは\nどのくらい頼りになりますか?\n上司", Score = 0, Reverse = false },
                new Question { Id = 5, Text = "あなたが困った時、次の人たちは\nどのくらい頼りになりますか?\n職場の同僚", Score = 0, Reverse = false },
                new Question { Id = 6, Text = "あなたが困った時、次の人たちは\nどのくらい頼りになりますか?\n配偶者、家族、友人等", Score = 0, Reverse = false },
                new Question { Id = 7, Text = "あなたの個人的な問題を相談したら、\n次の人たちはどのくらい聞いてくれますか?\n上司", Score = 0, Reverse = false },
                new Question { Id = 8, Text = "あなたの個人的な問題を相談したら、\n次の人たちはどのくらい聞いてくれますか?\n職場の同僚", Score = 0, Reverse = false },
                new Question { Id = 9, Text = "あなたの個人的な問題を相談したら、\n次の人たちはどのくらい聞いてくれますか?\n配偶者、家族、友人等", Score = 0, Reverse = false },
            },
